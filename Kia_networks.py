...
edges_LHIPP = [('Glx','mI',0.397),('Glx','tCr',0.439),('GSH','mI',0.359),
              ('GSH','tCr',0.567),('mI','tCho',.59),
              ('mI','tCr',0.58),('tNAA','tCho',.491),('tNAA','tCr',.604), 
              ('tCho','tCr',.597),]      #('Cr','Lac',.633)

edges_mPFC = [('Glx','Glu',.922),('Glx','Gln',.698),('Glx','mI',.325),
              ('Glu','Gln',.401),
              ('Gln','tCho',.327),('mI','tCho',.354),
              ('tNAA','tCho',.474),('tNAA','tCr',.649),('tCho','tCr',.414)]

edges_LSM1 = [('Glx','Glu', .921),('Glx','Gln',.769),('Glx','mI',.459),
              ('Glx','tCr',.329),
              ('Glu','Gln',.515),('Glu','mI',.39),('Glu','tNAA',.341),
              ('Glu','tCr',.387),('Gln','mI',.336),('mI','tCr',.463),('tNAA','tCr',.442),
              ('tCho','Lac',.421)]

edges_PCC = [('Glx','Glu',.945),('Glx','Gln',.709),('Glx','mI',.487),('Glu','Gln',.498),
             ('Glu','mI',.469),('Gln','GSH',.477),('Gln','mI',.349),('Gln','tNAA',.440),
             ('GSH','tNAA',.395),('mI','tCho',.460),('tNAA','tCho',.517),('tNAA','tCr',.733),
             ('tCho','tCr',.328),('tCho','Lac',.392)]
...
edges_LHIPPc = [('GSH','mI',0.481),('GSH','tCr',0.593),('mI','tCho',0.635),
               ('mI','tCr',.748),#('mI','Lac',.952),
              ('tNAA','tCr',0.501),('tCho','tCr',.625)]

edges_mPFCc = [('Glx','Glu',.942),('Glx','Gln',.761),('Glu','Gln',.565),('GSH','tCr',.757),
              ('mI','tCho',.486),('tNAA','tCr',.577)]

edges_LSM1c = [('GABA+','Glx',.494),('GABA+','Glu',.576),('GABA+','tCr',.515),('Glx','Glu',.957),
             ('Glx','Gln',.507),('Glu','Lac',.474),('tNAA','tCr',.503)]

edges_PCCc = [('Glx','Glu',.947),('Glx','Gln',.708),('Glu','Gln',.514),('Gln','tNAA',.540),
             ('Gln','tCr',.498),('mI','tCho',.569),('tNAA','tCho',.503),('tNAA','tCr',.668),
             ('tCho','Lac',.508)]
...
#LHIPPp.add_node('Glx', color = 'green')
#LHIPPp.add_node('GSH', color = 'blue')
#LHIPPp.add_node('mI', color = 'magenta')
#LHIPPp.add_node('NAA', color = 'yellow')
#LHIPPp.add_node('Cho', color = 'green')
#LHIPPp.add_node('Cr', color = 'purple')
#LHIPPp.add_node('Lac', color = 'pink')
...
edges_LHIPPp = [('Glx','tCr',0.522),('GSH','tCho',0.548),('mI','tCho',0.519),
               ('mI','tCr',.613),('tNAA','tCho',.573),('tNAA','tCr',.701),
               ('tCho','tCr',.662)]

edges_mPFCp = [('Glx','Glu',.917),('Glx','Gln',.489),('tNAA','tCho',.648),
               ('tNAA','tCr',.627),('GSH','mI',.53)]

edges_LSM1p = [('Glx','Glu',.880),('Glx','Gln',.873),('Glu','Gln',.593),
               ('Glu','tNAA',.539),('Glu','tCr',.538),('mI','tCho',.487),
               ('mI','tCr',.619),('tCr','Lac',.503),('tNAA','Glx',.51)]

edges_PCCp = [('GABA+','Glx',.659),('GABA+','Glu',.763),('GABA+','mI',.357),
              ('Glx','Glu',.945),('Glx','Gln',.825),('Glx','mI',.735),
              ('Glu','Gln',.638),('Glu','mI',.633),
              ('Gln','mI',.650),('tNAA','tCho',.514),('tNAA','tCr',.699)]
...
edges_GABA =[('mPFC','LSM1',.456)]


edges_Glx = []

edges_Glu = [('mPFC','PCC',.374)]

edges_Gln = []

edges_GSH = [('LSM1','mPFC',.383)]

edges_mI = [('LHIPP','LSM1',.434),('LHIPP','PCC',.507),('mPFC','LSM1',.441),
            ('mPFC','PCC',.495),('LSM1','PCC',.698)]

edges_NAA = [('LSM1','mPFC',.424),('LSM1','PCC',.402)]

edges_Cho = [('LHIPP','PCC',.356)]

edges_Cr = [('LHIPP','LSM1',.423),('mPFC','LSM1',.572),('mPFC','PCC',.382),
            ('PCC','LSM1',.368)]

edges_Lac = [('LHIPP','PCC',.681)]
...
edges_mIc = [('LHIPP','PCC',.615),('LSM1','mPFC',.623),('mPFC','PCC',.61)]

edges_NAAc = [('PCC','mPFC',.567)]

edges_Choc = [('LHIPP','mPFC',.612)]

edges_Crc = [('LHIPP','LSM1',.495),('LSM1','mPFC',.781),('PCC','mPFC',.56),
             ('PCC','LSM1',.51)]
...
edges_mIp = [('LHIPP','PCC',.544),('LSM1','PCC',.698)]

edges_NAAp = [('mPFC','LSM1',.563),('LSM1','PCC',.402)]

edges_Chop = []

edges_Crp = [('LHIPP','LSM1',.51),('LHIPP','PCC',.615),('LSM1','mPFC',.479)]           
